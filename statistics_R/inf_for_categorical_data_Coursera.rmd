...
spain <- atheism %>% filter(tolower(nationality)=="spain") %>% group_by(year)

inference(y=response, x=as.factor(year) ,data = spain, type = "ht", null = 0, statistic = "proportion", success = "atheist", method = "theoretical", alternative = "twosided", sig_level = 0.05, conf_level = 0.95)
...
# type your code for Question 10 here, and Knit
usa <- atheism %>% filter(tolower(nationality)=="United States") %>% group_by(year)

inference(y=response, x=as.factor(year) ,data = usa, type = "ht", null = 0, statistic = "proportion", success = "atheist", method = "theoretical", alternative = "twosided", sig_level = 0.05, conf_level = 0.95)
```
